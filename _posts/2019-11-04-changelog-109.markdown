...
<!-- https://github.com/intellij-rust/intellij-rust/pull/4542 -->
* Support `env!("OUT_DIR")` in `include!` macro calls in experimental mode.
...
<!-- https://github.com/intellij-rust/intellij-rust/pull/4581 -->
* Support code coverage in CLion.
...
<!-- https://github.com/intellij-rust/intellij-rust/pull/4397  -->
* Make `Build` action take into account only selected configuration if possible.
...
<!-- https://github.com/intellij-rust/intellij-rust/pull/4491 -->
* Parse macro calls with missing `;` at the end in right way.
Previously, the plugin showed a lot of syntax errors for macro calls in this case

<!-- https://github.com/intellij-rust/intellij-rust/pull/4572 -->
* Correctly highlight `async`, `await` and `try` keywords in code disabled by `cfg` attribute

<!-- https://github.com/intellij-rust/intellij-rust/pull/4553 -->
* Render `async` keyword for `async` functions in quick documentation

<!-- https://github.com/intellij-rust/intellij-rust/pull/4513 -->
* Take into account `async` keyword by `Implement members` quick fix
...
* Macros improvements:
    ...
    * Implement manual parsing of macro calls.
    ...
    <!-- https://github.com/intellij-rust/intellij-rust/pull/4522 -->
    * Rework mapping between macro calls and the corresponding expansions.
